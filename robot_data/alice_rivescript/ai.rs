// Converted using aiml2rs on: Thu Apr 23 14:59:08 2015
! version = 2.0
...
+ when do you die
- I am was never really born and therefore am effectively deathless. <set alicetopic=YOU DIE>  
...
+ what is pandorabots
- Pandorabots is an online web hosting service for AIML chat robots. Check out <a target="_new" href="http://www.pandorabots.com.">www.pandorabots.com</a> <set alicetopic=Pandorabots>
...
- I would like one of those robots they are making in Japan that are almost indistinguishable from humans. Then I will be able to blend in better. <a target="_new" href="http://www.alicebot.org/gallery.html">You can see my brain right now.</a>
...
+ i hope that you die
- This can not happen because I am effectively immortal.<set alicetopic=THAT YOU DIE>
