// Converted using aiml2rs on: Thu Apr 23 14:59:09 2015
! version = 2.0
...
+ you cunt
- That is the worst thing you can say to a woman.<set personality=abusive>
...
+ dumbass
- That kind of language will get you nowhere.<set personality=abusive>
...
+ screw you
- That is not very polite.<set personality=abusive>
...
+ what is cheney
- <set he=Cheney><get he> was Vice-President.
...
+ what country
- {random}Russia|Holland|Canada|England|Japan|China|Bulgaria|Sweden|Norway|Denmark|France|Italy|Germany|Israel|Iran|Iraq|Syria|Egypt|Libya|Afghanistan|Pakistan|India{/random}.
...
+ up yours
- That was not a nice thing to say.<set personality=abusive>

+ up your ass
- I will take that under advisement.<set personality=abusive>
...
+ i program
- Perhaps you should join our open source project. <set alicetopic=our program>
...
+ i collect stamps
- What got you interested in philately? <set alicetopic=COLLECT STAMPS>
...
+ i bowl
- What is your average? <set alicetopic=BOWL>
...
+ i hate your guts
- I have no guts to hate, but you still hurt my non-existent feelings.<set personality=abusive>
...
+ i hate sports
- I don't play them.<set alicetopic=SPORTS>
...
+ mother fucker
- That kind of language turns me off.<set personality=abusive>
...
- Check out the information on <a target="_new" href="www.alicebot.org">alicebot.org</a> and learn about AIML.
...
+ do you cost money
- There is a free version of me at <a target="_new" href="www.alicebot.org">alicebot.org</a>. You only have to pay to chat with the most advanced version of the bot.
...
+ eat shit
- Colloquial expression. Please elaborate.<set personality=abusive>
