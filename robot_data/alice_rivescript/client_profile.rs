...
+ my spouse
* <get branch> == undefined => Who is your spouse?
- <set branch={@findspouse <get wife> xsplit <get husband>}><get spouse> is your spouse.</li>
